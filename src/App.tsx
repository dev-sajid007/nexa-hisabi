    ...
    <BrowserRouter>
      <Routes>
        <Route element={<Layout />}>
          ...
          <Route path="/sales" element={<Placeholder title="🛒 বিক্রয়" desc="পণ্য নির্বাচন → পরিমাণ → Discount → মোট → পরিশোধ → বাকি" />} />
          <Route path="/purchases" element={<Placeholder title="📥 ক্রয়" desc="Supplier → পণ্য → পরিমাণ → ক্রয় মূল্য → মোট" />} />
